            ...
            {categoriasBase.map((cat: any) => (
             <div key={cat.id} className="relative group/menu">
                <button 
                  ...
                  className={`px-6 py-2.5 rounded-full text-[10px] font-bold uppercase tracking-[0.2em] border-2 transition-all duration-300 flex items-center gap-2 ${
                    categoriaAtiva === cat.id 
                    ? 'bg-[#611F3A] text-white border-[#611F3A] shadow-md' 
        ...
        {carregando ? (
          ...
          <NoResults 
            mensagem={
              ...
              : `A coleção está sendo atualizada com peças exclusivas do Brás! Volte em breve.`
            } 
          />
        ) : (
      ...
      <footer className="bg-[#611F3A] pt-24 pb-12 px-6 md:px-12 text-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16 items-start text-center md:text-left">
          ...
          <div>
            ...
            <p className="text-xs font-light opacity-80 mb-6 leading-relaxed">
                Ambiente 100% seguro para suas compras. Aceitamos PIX e Cartões.
            </p>
